...
* covering linear regression on the MPG dataset and seeing how squared error can be shown in a bar chart and how the results relate to the MSE (mean squared error) 
